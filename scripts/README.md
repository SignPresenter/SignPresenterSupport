...
The pipeline expects the SignPresenter monorepo layout — `SignPresenterAdmin/` and `SignPresenterSupport/` as siblings — and reads the `.claude\instructions\` reference docs (templates.md, feeds.md, architecture.md).
